 ...
 *   - should call onItemClick after threshold delay
 *   - should not call onItemClick if double-click occurs
 *   - should handle clicks on different items separately
 *
 * Double-Click Handling:
 *   - should call onItemDoubleClick when handleDoubleClick is called
 *   - should clear pending single-click when double-click occurs
 *
 * Context Menu Handling:
 *   - should call onItemContextMenu when handleContextMenu is called
 *   - should prevent default when preventContextMenu is true
 *   - should not call onItemContextMenu for disabled items
 *
 * Hover Handling:
 *   - should track hovered item
 *   - should clear hovered item on mouse leave
 *   - should not call onItemHover for disabled items
 *
 * Disabled Items:
 *   - should not handle clicks for disabled items
 *   - should not handle double-clicks for disabled items
 *
 * Cleanup:
 *   - should cleanup pending timers on unmount
 *   - should cleanup when cleanup is called
 *
 * @author Scott Davis
 * @version 1.0.0
 * @license MIT
...
import { useUserInteractions } from '../../src/components/HandyTreeView/hooks/useUserInteractions';
