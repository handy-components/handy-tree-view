/**
 * @fileoverview HandyTreeItem – Tree Item Component
 *
 * Individual tree item component for HandyTreeView.
...
/**
 * Props for HandyTreeItem
 */
export interface HandyTreeItemProps {
  ...
  dragOver?: boolean;
  /** Position in set (for aria-posinset) */
  posInSet?: number;
  /** Set size (for aria-setsize) */
  setSize?: number;
}

/**
 * HandyTreeItem – Tree Item Component
 *
 ...
 * @returns HandyTreeItem component
 */
export const HandyTreeItem = forwardRef<HTMLLIElement, HandyTreeItemProps>(
  (props, ref) => {
    const {
      itemId,
      label,
...
HandyTreeItem.displayName = 'HandyTreeItem';

// Memoize component to prevent unnecessary re-renders
export const MemoizedHandyTreeItem = memo(HandyTreeItem, (prevProps, nextProps) => {
...
MemoizedHandyTreeItem.displayName = 'MemoizedHandyTreeItem';
