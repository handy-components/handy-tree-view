...
export const useScreenReader = (props: UseScreenReaderProps = {}) => {
  ...
  useEffect(() => {
    ...
    let liveRegion = document.getElementById('handy-tree-view-live-region');
    
    if (!liveRegion) {
      liveRegion = document.createElement('div');
      liveRegion.id = 'handy-tree-view-live-region';
  ...
  const announce = useCallback(
    (message: string, priority: 'polite' | 'assertive' = 'polite') => {
      ...
      // Use live region
      const liveRegion = liveRegionRef.current || document.getElementById('handy-tree-view-live-region');
      if (liveRegion) {
